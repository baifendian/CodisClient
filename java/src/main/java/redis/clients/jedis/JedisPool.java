...
//  }
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final String host, final int port, final String businessID) {
	    this(poolConfig, host, port, Protocol.DEFAULT_TIMEOUT,  Protocol.DEFAULT_TIMEOUT, null, Protocol.DEFAULT_DATABASE, null, businessID);
	  }
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final String host, int port,
	      final int connectionTimeout, final int soTimeout, final String password, final int database,
	      final String clientName, final String businessID) {
	    super(poolConfig, new JedisFactory(host, port, connectionTimeout, soTimeout, password,
	        database, clientName, businessID));
	  }
